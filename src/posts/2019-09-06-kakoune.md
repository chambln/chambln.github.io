...
-   Some people have reported slow startup times; for me it's a small
    ...
    *instant* feel as Vim.
-   [I had to implement essential line-editing chords like `<c-w>`
    myself][plugin that implements Readline shortcuts reasonably well in
    Kakoune]. The needlessly puristic reason given for their absence
